...
template <typename... Ts>
struct is_unwrappable<thrust::tuple<Ts...>> : ::cuda::std::_Or<is_unwrappable<Ts>...>
{};

// specialize is_unwrappable
// a tuple_of_iterator_references is_unwrappable if any of its elements is_unwrappable
template <typename... Ts>
struct is_unwrappable<thrust::detail::tuple_of_iterator_references<Ts...>> : ::cuda::std::_Or<is_unwrappable<Ts>...>
{};
