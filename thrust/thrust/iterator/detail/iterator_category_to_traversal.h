...
struct category_to_traversal
    ...
    : eval_if<::cuda::std::_Or<::cuda::std::is_convertible<Category, thrust::input_host_iterator_tag>,
              ...
              eval_if<::cuda::std::_Or<::cuda::std::is_convertible<Category, thrust::input_device_iterator_tag>,
