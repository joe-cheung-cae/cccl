...
struct is_host_iterator_category
    : ::cuda::std::_Or<::cuda::std::is_convertible<T, thrust::input_host_iterator_tag>,
                       ::cuda::std::is_convertible<T, thrust::output_host_iterator_tag>>
{}; // end is_host_iterator_category

template <typename T>
struct is_device_iterator_category
    : ::cuda::std::_Or<::cuda::std::is_convertible<T, thrust::input_device_iterator_tag>,
                       ::cuda::std::is_convertible<T, thrust::output_device_iterator_tag>>
{}; // end is_device_iterator_category

template <typename T>
struct is_iterator_category : ::cuda::std::_Or<is_host_iterator_category<T>, is_device_iterator_category<T>>
